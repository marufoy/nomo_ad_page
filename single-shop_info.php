            ...
            <div class="shop-content">
                ...
                <div class="media-area">
                    <div class="custom-thumbnail">
                        ...
                        if ($store_image): ?>
                            <a href="<?php echo esc_url($store_image['url']); ?>" class="popup-link">
                                <img src="<?php echo esc_url($store_image['url']); ?>"
                                    alt="<?php echo esc_attr($store_image['alt']); ?>">
                            </a>
                        <?php endif; ?>
                    </div>
                        ...
                        foreach ($detail_images as $detail_image):
                            if ($detail_image): ?>
                                <div class="detail-thumbnail">
                                    <a href="<?php echo esc_url($detail_image['url']); ?>" class="popup-link">
